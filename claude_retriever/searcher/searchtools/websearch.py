...
BRAVE_DESCRIPTION = 'The search engine will search over the Brave search engine for pages with keywords similar to your query. It returns for each page its title, a summary and potentially full page content. Use this tool if you want to get up-to-date and comprehensive information on a topic to help answer queries.'
